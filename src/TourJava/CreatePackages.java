 ...
 * @author steve
 */
public class CreatePackages extends javax.swing.JFrame implements ActionListener{
    ...
    String[] searchBy={"Select Category","Country","Destination","DepartingDate"};
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        {
            new CreateAndEditPackages(this,true,"","","",false).setVisible(true);
        ...
        else if(ae.getSource().equals(b2))
        {
            if(table.getSelectedRow()>=0)
            {
                ...
                String val7=dtm.getValueAt(curRow,7).toString();  
                 
                CreateAndEditPackages edit=new CreateAndEditPackages(this,true,val,val1,val4,true);
                edit.t1.setText(val2);
                edit.t2.setText(val3);
                edit.t3.setText(val5);
                edit.t4.setText(val6);
                edit.t5.setText(val7);             
            ...
            if(table.getSelectedRow()>=0)
            {
                if(JOptionPane.showConfirmDialog(this, "Are You Sure You Want To Delete?","Confirm",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION)
                {
                    ...
                    try
                    {
                        ...
                        sql="Delete From Packages Where PackageID='"+val+"'";
                        int result=ste.executeUpdate(sql);
                        if(result>0)
                        {
                            JOptionPane.showMessageDialog(this, "The Package Is Successfully Deleted","Deleting Process Accomplished", JOptionPane.INFORMATION_MESSAGE);
                        }
                    }
        ...
        else if(ae.getSource().equals(c1))
        {
            if(c1.getSelectedIndex()!=0)
            {
                ...
                {
                    ste=con.createStatement();
                    sql="Select "+c1.getSelectedItem().toString()+" From Packages Order By "+c1.getSelectedItem().toString();
        ...
        else if(ae.getSource().equals(b4))
        {
            ...
            else
            {
                if(dtm.getRowCount()>0)
                {
                    ...
                    sql="Select * From Packages Where "+c1.getSelectedItem().toString()+"='"+c2.getSelectedItem().toString()+"'";
                    showData(sql);
                }                
            }
        }
